...
func PinMessage(navbar *fyne.Container, chn_id, tkn, msg_id *widget.Entry, actions *widget.Select, confirm_action *widget.Button) {
	...
	confirm_action.OnTapped = func() {
		internalPinMessage(chn_id, tkn, msg_id)
	}
}

func internalPinMessage(chn_id, tkn, msg_id *widget.Entry) {
